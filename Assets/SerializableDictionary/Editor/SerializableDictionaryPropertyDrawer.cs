...
[CustomPropertyDrawer(typeof(GameObjectSubPartInfoDictionary))]
public class GameObjectSubPartInfoDictionaryPropertyDrawer : SerializableDictionaryPropertyDrawer { }
...
public class SerializableDictionaryPropertyDrawer : PropertyDrawer
{
	...
	{
		// Disable to avoid errors when more than one object is selected
